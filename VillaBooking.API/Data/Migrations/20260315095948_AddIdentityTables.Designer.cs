...
namespace VillaBooking.API.Data.Migrations
{
    ...
    [Migration("20260315095948_AddIdentityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VillaBooking.API.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VillaBooking.API.Models.VillaAmenity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VillaBooking.API.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VillaBooking.API.Models.VillaAmenity", b =>
                {
                    b.HasOne("VillaBooking.API.Models.Villa", "Villa")
                        .WithMany()
